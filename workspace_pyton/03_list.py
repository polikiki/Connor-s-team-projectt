a = [1, 1.2, '문자', True] # 배열에 함수도 포함이 가능함
print(a)
print(a[1])
...
# range
# range(시작index, 종료 index, step)
# 시작index부터 종료index 바로 앞까지 step 만큼 증가
# 시작index 기본값 : 0
# step 기본값 : 1
a = range(10) # 전달인자가 하나인 경우 종료index로 인식
print(a)
print(list(a))
print(list(range(4, 10, 2))) # 4부터 10바로 앞까지 2씩 증가
print(list(range(10, 0, 2))) # 종료 index가 시작보다 더 작으면 비어있음 (아무것도 되지 않음)
print(list(range(10, 0, -1))) # step은 음수가 될 수 있음 

a = 10
b = 20
a,b = b,a # 파이썬 에서는 b와 a를 쉽게치환하는 것이 가능하다
