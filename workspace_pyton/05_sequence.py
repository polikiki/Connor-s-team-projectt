...
c = "abcde"
print(c[0])
# c[0] = 'b' # index로 접근하는 경우 range, 튜플, 문자열은 읽기만 된다(Readonly) 수정x
...
print( a[:] ) # a[::]랑 같음 (모두 출력)
print( a[::2] ) # 모두 출력인데 2씩 건너 뛰면서
print( a[5:1:-1]) # step을 음수로 지정 할 수 있다
...
a[2:4] = [1]
print(a) # 2개가 1로 줄음
a[2:4] = [1,2,3,4,5,6,7,8,9] # 즉 수정하는 값은 숫자가 맞춰지지 않아도 된다
print(a)
