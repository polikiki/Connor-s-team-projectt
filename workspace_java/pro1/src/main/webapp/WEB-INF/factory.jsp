                ...
                <tbody class="tbody">
                    ...
                    %>
                                <tr>
                                    ...
                                    <td><a href="factory_Detail?processCode5=<%= processCode %>"><%= processCode %></a></td>
                                    <td><%= processName %></td>
                                    <td><%= processType %></td>
                                    <td><%= productCode %></td> 
                                    <td><%= useYn %></td>
...
function sendProcessCode(processCode) {
    window.location.href = `ProcessServlet2?processCode=${processCode}`;
}
