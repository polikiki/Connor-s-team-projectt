				...
				<tbody class="tbody">
					<c:forEach var="PM" items="${map.list }">
						<tr>
							...
							<td><a
								href="http://127.0.0.1:8080/peanutbutter/modify?product_code=${PM.product_code}">${PM.product_name }</a></td>
...
<script>
    ...
    function commitReg(){
    	location.href="http://127.0.0.1:8080/peanutbutter/insert";
    }
    	a = '${map.optionvalue}';
    	b = '${map.search}';
    ...
    function searchpage(num){
    	...
    	let url = "http://127.0.0.1:8080/peanutbutter/pm?page=" + num;
    	
    	
    	if(a != ''){    		
//     		location.href="http://127.0.0.1:8080/peanutbutter/pm?optionvalue="+a+"&search="+b+"&page=num";
