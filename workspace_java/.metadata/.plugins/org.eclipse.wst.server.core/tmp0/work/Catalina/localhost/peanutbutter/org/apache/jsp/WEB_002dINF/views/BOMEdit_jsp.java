 ...
 * Generated at: 2024-09-08 07:58:04 UTC
...
public final class BOMEdit_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("    <title>BOM 수정(부품)</title>\r\n");
      out.write("    <style>\r\n");
      out.write("    * {\r\n");
      ...
      out.write("            </div>\r\n");
      out.write("            <form id=\"bomForm\" action=\"EditBOMServlet\" method=\"post\">\r\n");
      ...
      out.write("     		<span class=\"Btn_css\" onclick=\"submitForm()\">BOM 공정 수정</span>\r\n");
      out.write("    	</div>   	\r\n");
      out.write("</div>\r\n");
      out.write("</body>\r\n");
      out.write("<script>\r\n");
      ...
      out.write("            const [code, size, unit] = data.split('|'); // 서버 응답을 코드, 사이즈, 단위로 분리\r\n");
      ...
      out.write("\r\n");
      out.write("            codeCell.textContent = code;\r\n");
      out.write("            sizeCell.textContent = size;\r\n");
      out.write("            unitCell.textContent = unit; // 단위 필드 업데이트\r\n");
      out.write("        })\r\n");
      ...
      out.write("}\r\n");
      out.write("document.querySelector('.제품select').addEventListener('change', function() {\r\n");
      out.write("    let selectedProduct = this.value;\r\n");
      out.write("\r\n");
      out.write("    // 서버로 제품 목록에 대한 데이터 요청\r\n");
      out.write("    fetch('GetBOMData?product_list=' + encodeURIComponent(selectedProduct))\r\n");
      out.write("        .then(response => response.json())\r\n");
      out.write("        .then(data => {\r\n");
      out.write("            populateBOMTable(data); // 받아온 데이터를 테이블에 표시\r\n");
      out.write("        })\r\n");
      out.write("        .catch(error => console.error('Error fetching BOM data:', error));\r\n");
      out.write("});\r\n");
      out.write("\r\n");
      out.write("\r\n");
      out.write("function populateBOMTable(data) {\r\n");
      out.write("    let tbody = document.querySelector('.tbody');\r\n");
      out.write("    tbody.innerHTML = ''; \r\n");
      out.write("\r\n");
      out.write("    data.forEach((item, index) => {\r\n");
      out.write("\r\n");
      out.write("        if (!item || Object.keys(item).length === 0) {\r\n");
      out.write("            console.warn('Empty object found, skipping:', item);\r\n");
      out.write("            return;\r\n");
      out.write("        }\r\n");
      out.write("\r\n");
      out.write("        let partName = item.part_name || 'N/A';\r\n");
      out.write("        let modelName = item.model_name || 'N/A';\r\n");
      out.write("        let partCode = item.part_code || 'N/A';\r\n");
      out.write("        let standard = item.standard || 'N/A';\r\n");
      out.write("        let unit = item.unit || 'N/A';\r\n");
      out.write("        let mount = item.mount || '';\r\n");
      out.write("        let company = item.company || '';\r\n");
      out.write("\r\n");
      out.write("        let newRow = document.createElement('tr');\r\n");
      out.write("        newRow.innerHTML = '<td><input type=\"checkbox\" class=\"delete-checkbox\"></td>' +\r\n");
      ...
      out.write("            '</select></td>' +\r\n");
      out.write("            '<td class=\"code\">' + partCode + '</td>' +\r\n");
      out.write("            '<td class=\"size\">' + standard + '</td>' +\r\n");
      out.write("            '<td class=\"unit\">' + unit + '</td>' +\r\n");
      out.write("            '<td><input type=\"text\" name=\"quantity[]\" value=\"' + mount + '\" style=\"width: 30%;\"></td>' +\r\n");
      out.write("            '<td><input type=\"text\" name=\"company[]\" value=\"' + company + '\"></td>';\r\n");
      out.write("        tbody.appendChild(newRow);\r\n");
      out.write("        \r\n");
      out.write("        console.log('New row HTML:', newRow.innerHTML);  // 새로 생성된 행의 HTML 확인\r\n");
      out.write("\r\n");
      out.write("    });\r\n");
      out.write("}\r\n");
      out.write("\r\n");
