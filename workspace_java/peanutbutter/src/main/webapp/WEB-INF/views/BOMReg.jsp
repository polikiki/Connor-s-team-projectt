...
<body>
 <div class="container">
    ...
    <div class="section">
        <div class="tableDiv">
            <div class="tableTopDiv">
                ...
                <span class="Btn_css" style="margin-left: 20px;" onclick="deleteSelectedRow()">행 삭제</span>              
               		<span class="Btn_css" id="editBtn"  style="margin-left: 50px;"  onclick="editBOM()">정보 수정</span>   
            </div>
            <form id="bomForm" action="SubmitBOMServlet" method="post">
    	...
    	<div class="regBtn">
     		<span class="Btn_css" onclick="submitForm()">BOM 공정 등록</span>
    	</div>   	
</div>
<script>
function addRow() { 
